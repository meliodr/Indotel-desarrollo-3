...
Prototipo académico avanzado para gestión de reclamaciones ciudadanas, compuesto por Core, API Gateway, portal Web, aplicación interna Caja, SQL Server y un release reproducible con Docker.
...
Web y Caja no acceden directamente al Core interno ni a SQL Server. El Core conserva autorización, propiedad, reglas de estados y persistencia.

## Componentes

| Componente | Tecnología | Rama |
|---|---|---|
| Core | ASP.NET Core 8, EF Core, JWT, SQL Server | `core` |
...
La caída de un servicio no debe cerrar Caja ni producir una pantalla técnica en Web.
